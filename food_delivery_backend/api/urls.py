...
urlpatterns = [
    ...
    path('menu-items/categories/', views.CategoriesView.as_view(), name='menu-items-categories'),
    path('menu-items/categories/<str:category>/', views.CategoriesViewItems.as_view(), name='category-details'),
